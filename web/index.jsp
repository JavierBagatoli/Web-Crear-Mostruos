...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  <div id="pageintro" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <article>
      <h3 class="heading">Generador de Mostruos</h3>
      <p>Siempre has crei que las curaturas mas terrorificas existian en la mente ahora puede que sean reales y con limites</p>
      <footer>
        <ul class="nospace inline pushright">
          <li><a class="btn" href="#">Generar</a></li>
          <li><a class="btn inverse" href="#">Galeria</a></li>
        </ul>
      </footer>
    </article>
    <!-- ################################################################################################ -->
